...
discussionRouter = routers.DefaultRouter()
discussionRouter.register(r'reply', projectView.DiscussionReplyViewSet)
...
urlpatterns = [
    ...
    url(r'^project/(?P<project_id>\d+)/discussion/(?P<discussion_id>\d+)/', include(discussionRouter.urls)),
